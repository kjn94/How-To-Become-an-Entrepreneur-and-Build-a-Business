...
?>
<?php
	$sql = "SELECT * FROM mainmenu WHERE parent = 1 ORDER BY Menu DESC";
	$footermenu = $db->query($sql);
?>
<head>
<link href="http://localhost/menu/css/footer2.css" rel="stylesheet" type="text/css" />
...
<?php while($footer = mysqli_fetch_assoc($footermenu)) : ?>
			...
			<!-- MENU ITEMS -->
			<li class="footer">
				<a href="<?php echo $footer['href']?>" class="footer"><?php echo $footer['Menu']?>
				</a>
			</li>
    ...
    <div class="box-row">
      <div class="box-cell one">
        <div class="box-content">
            <div id="hoverfooter">        
				<a href="http://localhost/menu/pages/blog/blog_category.php?cid=1"><h3><b>SUCCESS STORIES</b></h3>
				</a>				
			</div>
					<?php 
      ...
      <div class="box-cell two">
        <div class="box-content">
            <div id="hoverfooter">        
        		<a href="http://localhost/menu/pages/blog/blog_category.php?cid=2">
      ...
      <div class="box-cell three">
        <div class="box-content">
            <div id="hoverfooter">        
        		<a href="http://localhost/menu/pages/blog/blog_category.php?cid=4">
						<h3><b>LyfeStyle</b></h3>
				</a>					
			</div>
				<?php 
      ...
      <div class="box-cell three">
        <div class="box-content">
            <div id="hoverfooter">        
        		<a href="http://localhost/menu/pages/blog/blog_category.php?cid=3">
